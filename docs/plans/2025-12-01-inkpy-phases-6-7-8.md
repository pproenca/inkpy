...
**Files:**
- `python_port/inkpy/components/app_context.py`
- `python_port/inkpy/hooks/use_app.py`
- `python_port/tests/test_use_app.py`

**Reference:** `src/components/AppContext.ts`, `src/hooks/use-app.ts`
...
Create `python_port/inkpy/components/app_context.py`:
...
Create `python_port/inkpy/hooks/use_app.py`:
- Import and use ReactPy's `use_context`
- Return the AppContext value

**Verification:**
```bash
cd python_port && pytest tests/test_use_app.py -v
```
...
**Files:**
- `python_port/inkpy/components/stdout_context.py`
- `python_port/inkpy/components/stderr_context.py`
- `python_port/inkpy/hooks/use_stdout.py`
- `python_port/inkpy/hooks/use_stderr.py`
- `python_port/tests/test_std_hooks.py`

**Reference:** `src/components/StdoutContext.ts`, `src/components/StderrContext.ts`, `src/hooks/use-stdout.ts`, `src/hooks/use-stderr.ts`
...
Create `python_port/inkpy/components/stdout_context.py`:
- Create ReactPy context
- Context value: `{'stdout': TextIO, 'write': Callable[[str], None]}`

**Step 3: Implement StderrContext**

Create `python_port/inkpy/components/stderr_context.py`:
- Create ReactPy context
...
**Verification:**
```bash
cd python_port && pytest tests/test_std_hooks.py -v
```
...
**Files:**
- `python_port/inkpy/components/focus_context.py`
- `python_port/inkpy/hooks/use_focus.py`
- `python_port/inkpy/hooks/use_focus_manager.py`
- `python_port/tests/test_focus.py`

**Reference:** `src/components/FocusContext.ts`, `src/hooks/use-focus.ts`, `src/hooks/use-focus-manager.ts`
...
Create `python_port/inkpy/components/focus_context.py`:
- Create ReactPy context
...
Create `python_port/inkpy/hooks/use_focus.py`:
...
**Files:**
- `python_port/inkpy/ink.py`
- `python_port/inkpy/components/app.py` (App wrapper component)
- `python_port/tests/test_ink.py`

**Reference:** `src/ink.tsx`, `src/components/App.tsx`
...
Create `python_port/inkpy/components/app.py`:
- Port from `src/components/App.tsx`
- Manage focus state
...
Create `python_port/inkpy/ink.py`:
- Port from `src/ink.tsx`
...
**Verification:**
```bash
cd python_port && pytest tests/test_ink.py -v
```
...
**Files:**
- `python_port/inkpy/render.py`
- `python_port/tests/test_render.py`

**Reference:** `src/render.ts`
...
Create `python_port/inkpy/render.py`:
...
Create `python_port/inkpy/instances.py`:
...
**Verification:**
```bash
cd python_port && pytest tests/test_render.py -v
```
...
**Files:**
- `python_port/inkpy/dom.py`
- `python_port/tests/test_dom.py`

**Reference:** `src/dom.ts`
...
Create `python_port/inkpy/dom.py`:

Port from `src/dom.ts`:
...
Ensure these exist:
- `python_port/inkpy/measure_text.py` - Text measurement
- `python_port/inkpy/wrap_text.py` - Text wrapping

**Verification:**
```bash
cd python_port && pytest tests/test_dom.py -v
```
...
**Files:**
- `python_port/inkpy/backend/tui_backend.py` (enhance existing)
- `python_port/tests/test_tui_backend.py`
...
Enhance `python_port/inkpy/backend/tui_backend.py`:
...
**Verification:**
```bash
cd python_port && pytest tests/test_tui_backend.py -v
```
...
**Files:**
- `python_port/examples/counter.py`
- `python_port/tests/test_counter_e2e.py`
...
Create `python_port/examples/counter.py`:
...
```bash
cd python_port && python examples/counter.py
```
...
**Files:**
- `python_port/examples/interactive.py`
- `python_port/tests/test_interactive_e2e.py`
...
Create `python_port/examples/interactive.py`:
...
```bash
cd python_port && python examples/interactive.py
```
...
**Files:**
- `python_port/examples/hello_world.py`
...
```bash
cd python_port && python examples/hello_world.py
```
...
**Files:**
- `python_port/inkpy/__init__.py`

**Step 1: Define public API**

Create `python_port/inkpy/__init__.py`:
...
```bash
cd python_port && python -c "from inkpy import render, Box, Text; print('OK')"
```
...
Create `python_port/inkpy/py.typed` (empty file) to indicate type hint support.

**Step 3: Run mypy**

```bash
cd python_port && mypy inkpy/
```
...
**Files:**
- `python_port/tests/test_integration.py`
...
```bash
cd python_port && pytest tests/test_integration.py -v
```
