#!/usr/bin/env python3
"""
Interactive Example using Custom Reconciler

Demonstrates:
- Synchronous state updates (no double render)
- Keyboard navigation
- Clean exit handling
"""
...
@component
def SelectList():
    """Interactive selection list with arrow key navigation"""
...
if __name__ == "__main__":
    print("Use arrow keys to navigate, Enter to select, Exit to quit")
