...
async def test_text_hides_when_aria_hidden_in_screen_reader_mode():
    ...
    def App():
        return accessibility_context(
            Text(aria_hidden=True, children="Hidden text"), value={"is_screen_reader_enabled": True}
        )
...
async def test_text_uses_children_when_no_aria_label():
    ...
    def App():
        return accessibility_context(
            Text(children="Regular text"), value={"is_screen_reader_enabled": True}
        )
...
async def test_text_handles_none_children():
    ...
    @component
    def App():
        return accessibility_context(Text(children=None), value={"is_screen_reader_enabled": False})
