...
def test_render_with_custom_reconciler():
    ...
    @component
    def App():
        return create_element("ink-box", {}, create_element("ink-text", {}, "Hello World"))
...
class TestEnterKeyParsing:
    ...
    def test_return_property_works(self):
        ...
        assert nl_key.return_ is True, "return_ should be True for \\n (regression)"
...
class TestStaleClosureRegression:
    ...
    def test_use_input_handler_updates_on_rerender(self):
        ...
        """
        from inkpy import render
        from inkpy.reconciler import component, use_input, use_state
...
class TestEffectLifecycle:
    ...
    def test_effect_reruns_when_deps_change(self):
        ...
        from inkpy import render
        from inkpy.reconciler import component, use_effect, use_state
        from inkpy.reconciler.element import create_element
        ...
        assert effect_runs == [0, 5], f"Effect should re-run when deps change. Got: {effect_runs}"
