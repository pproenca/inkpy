...
def Text(
    ...
    **kwargs,
    ...
    effective_background = (
        effective_bg_color if effective_bg_color is not None else inherited_background
    )
    ...
    children_or_aria_label = aria_label if (is_screen_reader_enabled and aria_label) else children
