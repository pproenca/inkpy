...
def test_accessibility_context_default_value():
    ...
    default_value = getattr(accessibility_context, 'default_value', None) or getattr(accessibility_context, 'default', None)
...
def test_background_context_default_value():
    ...
    default_value = getattr(background_context, 'default_value', None) or getattr(background_context, 'default', None)
